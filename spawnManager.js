...
var spawnManager = {
    ...
    **/
    run : function(spawn){
        ...
        var soldierBodies = [[TOUGH, MOVE, TOUGH, MOVE, TOUGH, MOVE, TOUGH, MOVE, TOUGH, MOVE, MOVE, ATTACK, MOVE, RANGED_ATTACK, MOVE, RANGED_ATTACK, MOVE, ATTACK, MOVE, ATTACK, MOVE, ATTACK],[TOUGH, MOVE, TOUGH, MOVE, RANGED_ATTACK, MOVE, ATTACK, MOVE, ATTACK, MOVE],[RANGED_ATTACK, MOVE, RANGED_ATTACK, MOVE, ATTACK, MOVE],[TOUGH, MOVE, RANGED_ATTACK, MOVE, ATTACK, MOVE], [TOUGH, MOVE, ATTACK, MOVE]];
